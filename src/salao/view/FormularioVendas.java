...
public class FormularioVendas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PainelProdutoLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtCodigo, txtPreco, txtProduto});
        ...
        PainelProdutoLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtCodigo, txtPreco, txtProduto});
        ...
        if (Carrinho.getColumnModel().getColumnCount() > 0) {
            Carrinho.getColumnModel().getColumn(2).setHeaderValue("Qtd");
        }
...
//        txtStock.setText(tabelaProduto.getValueAt(tabelaProduto.getSelectedRow(), 4).toString());
    ...
    private void txtCodigoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            obj = dao.BuscarServicosCodigo(id);
    ...
    private void txtPesquisaProdutoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisaProdutoKeyReleased
        ...
        ServicosDAO dao = new ServicosDAO();
        List<Servicos> lista = dao.Filtrar(nome);
        DefaultTableModel dados = (DefaultTableModel) tabelaProduto.getModel();
        dados.setNumRows(0);
        for (Servicos p : lista) {
            dados.addRow(new Object[]{
                p.getId(),
                p.getDescricao(),
                p.getPreco(),
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        if(obj.getDescricao()!=null){
            ...
            //Verificação do stock existente e do stokc solicitado
